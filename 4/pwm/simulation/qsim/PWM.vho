...
SIGNAL \sc_counter~2_combout\ : std_logic;
SIGNAL \sc_counter[0]~feeder_combout\ : std_logic;
...
\sc_counter~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \sc_counter~2_combout\ = (!sc_counter(0) & ((!sc_counter(1)) # (!sc_counter(2))))
...
PORT MAP (
	...
	datac => sc_counter(1),
	datad => sc_counter(0),
	combout => \sc_counter~2_combout\);

-- Location: LCCOMB_X1_Y11_N24
\sc_counter[0]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \sc_counter[0]~feeder_combout\ = \sc_counter~2_combout\
...
-- pragma translate_on
PORT MAP (
	datab => \sc_counter~2_combout\,
	combout => \sc_counter[0]~feeder_combout\);
...
-- Equation(s):
-- \sc_counter~1_combout\ = (sc_counter(1) & (!sc_counter(2) & sc_counter(0))) # (!sc_counter(1) & (sc_counter(2)))
...
-- Equation(s):
-- \sc_counter~0_combout\ = (sc_counter(1) & (!sc_counter(2) & !sc_counter(0))) # (!sc_counter(1) & ((sc_counter(0))))
...
-- Equation(s):
-- \LessThan2~0_combout\ = (pwm_counter(1) & (!pwm_counter(0) & (\duty[0]~input_o\ & \duty[1]~input_o\))) # (!pwm_counter(1) & ((\duty[1]~input_o\) # ((!pwm_counter(0) & \duty[0]~input_o\))))
...
-- Equation(s):
-- \LessThan2~1_combout\ = (pwm_counter(2) & (\duty[2]~input_o\ & \LessThan2~0_combout\)) # (!pwm_counter(2) & ((\duty[2]~input_o\) # (\LessThan2~0_combout\)))
